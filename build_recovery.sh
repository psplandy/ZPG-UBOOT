...
pack_spi_full_image()
{
	...
	dd if=./arch/arm/dts/odroidgoa-kernel-v11.dtb of=${OUT}/spi_recovery.img bs=512 seek=8192 count=200 conv=fsync,notrunc
...
pack_recovery_sdcard_img()
{
	...
	sudo cp ./arch/arm/dts/odroidgoa-kernel-v11.dtb ${MNT}/rk3326-odroidgoa-linux-v11.dtb
	sync
	sudo umount ${MNT}
